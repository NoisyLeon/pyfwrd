...
rsolver1.solve_raysum(bazin=np.arange(12)*30.)
rsolver1.plot_baz_rf(comp='R', showfig=False)


rsolver2  = ref.ref_solver(m2)
rsolver2.init_default_2()
rsolver2.solve_raysum(bazin=np.arange(12)*30.)
rsolver2.plot_baz_rf(comp='R')
