...
c- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        subroutine tregn96_subroutine(hs_in,hr_in,
    2      ohr_in,ohs_in, refdep_in, nl_in, iflsph_in,
...
c   Input arrays, added by LF
        real*8 hs_in, hr_in, ohr_in, ohs_in, refdep_in
        integer nl_in, iflsph_in
        real*8 d_in(nl_in),TA_in(nl_in),TC_in(nl_in),TF_in(nl_in)
        real*8 TL_in(nl_in),TN_in(nl_in),TRho_in(nl_in)
        real*8 qai_in(nl_in),qbi_in(nl_in),etapi_in(nl_in)
        real*8 etasi_in(nl_in),frefpi_in(nl_in),frefsi_in(nl_in)
