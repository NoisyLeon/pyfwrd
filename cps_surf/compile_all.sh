...
f2py -h tdisp96.pyf -m tdisp96 tdisp96.f mnmarg.f mgtarg.f lgstr.f tio.f mchdep.f  tgetmod.f
f2py --f77flags="-ffixed-line-length-none -O3" --f90flags="-O3" -c tdisp96.pyf tdisp96.f mnmarg.f mgtarg.f lgstr.f tio.f mchdep.f tgetmod.f
